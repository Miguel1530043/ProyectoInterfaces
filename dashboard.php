...
<html lang="en">
    ...
    <?php 
        ...
        */
        $consulta = "SELECT * FROM administrador where correo = '$email'";
    ...
    ?>
                        ...
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right top-navbar-items-right pull-right">
                                <li class="dropdown top-menu-item-xs">
                                    <a href="" class="dropdown-toggle menu-right-item profile" data-toggle="dropdown" aria-expanded="true"><img src="assets/images/users/<?php echo "$ver[foto]"?>" alt="user-img" class="img-circle"><i class="mdi mdi-chevron-down"></i> </a>
                    ...
                    <div class="scrollbar-wrapper">
                        <div>
                            ...
                            <div class="user-details">
                                <div class="pull-left">
                                    <img src="assets/images/users/<?php echo "$ver[foto]"?>" alt="" class="thumb-md img-circle">
                                </div>
                                <div class="user-info">
                                    <?php echo "<a href='perfil.php?correo=$email'> $ver[nombre] $ver[apellidos]</a>";?>
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
									...
									<div class="row">
										<div class="col-lg-3 col-sm-6">
											<div class="widget-inline-box text-center">
												<h3 class="m-t-10"><i class="text-primary  mdi mdi-cash-usd"></i> <b data-plugin="counterup">8954</b></h3>
										...
										<div class="col-lg-3 col-sm-6">
											<div class="widget-inline-box text-center">
												<h3 class="m-t-10"><i class="text-custom  mdi mdi-cash"></i> <b data-plugin="counterup">7841</b></h3>
												<p class="text-muted">Ingresos del Dia</p>
											</div>
										</div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                    <h4 class="m-t-0">Ganancias Totales</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    <h4 class="m-t-0">Estadisticas de Ventas</h4>
                                    <div class="text-center">
                                        <ul class="list-inline chart-detail-list">
                                            <li>
                                                <h5 class="font-normal"><i class="fa fa-circle m-r-10 text-primary"></i>Domicilio</h5>
                                            </li>
                                            <li>
                                                <h5 class="font-normal"><i class="fa fa-circle m-r-10 text-info"></i>En Restaurant</h5>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <img src="assets/images/users/<?php echo "$emp[foto]";?>" alt="contact-img" title="contact-img" class="img-circle thumb-sm" />
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="#" class="text-muted"><?php echo "$emp[correo]";?></a>
                                                    </td>

                                                    <td>
                                                        <b><a href="" class="text-dark"><b><?php echo "$emp[telefono]";?></b></a> </b>
                                                    </td>
        ...
        <?php
            ...
            if($cont1==1 && $cont2==1){
                $_SESSION['inicio_sesion']="dog";*/
            $consultaEmp = "SELECT * FROM empleado where correo = '$email'";
            $resultadoEmp = mysqli_query($conexion,$consultaEmp);
            $verEmp = mysqli_fetch_array($resultadoEmp);
                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right top-navbar-items-right pull-right">
                                <li class="dropdown top-menu-item-xs">
                                    <a href="" class="dropdown-toggle menu-right-item profile" data-toggle="dropdown" aria-expanded="true"><img src="assets/images/users/<?php echo "$verEmp[foto]"?>" alt="user-img" class="img-circle"> </a>
                                    <ul class="dropdown-menu">
                ...
                <aside class="sidebar-navigation">
                    <div class="scrollbar-wrapper">
                        <div>
                            ...
                            <div class="user-details">
                                <div class="pull-left">
                                    <img src="assets/images/users/<?php echo "$verEmp[foto]"?>" alt="" class="thumb-md img-circle">
                                </div>
                                <div class="user-info">
                                    <a href="#"><?php echo "$verEmp[nombre] $verEmp[apellidos]"?></a>
