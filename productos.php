                      ...
                      <div class="col-sm-12">
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                          <thead>
                            ...
                            <tbody>
                            <?php
                              $consulta = mysqli_query($conexion,"SELECT * FROM productos WHERE tipo = 'Hamburguesa'");
                              while($hamb = mysqli_fetch_array($consulta)){
                            ?>
                            <tr>
                              <td><?php echo "$hamb[id]";?></td>
                              <td><?php echo "$hamb[nombre]";?></td>
                              <td>$<?php echo "$hamb[precio]";?>,00</td>
                              <?php echo "<td>$hamb[descripcion]</td>";?>
                            </tr>
                            <?php
                             }
                            ?>
                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <label>Papas</label>
                        <table table id="datatable-colvid" class="table table-striped table-bordered" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                               <th>ID</th>
                              <th>Nombre</th>
                            ...
                            <tbody>
                            <?php
                              $consulta = mysqli_query($conexion,"SELECT * FROM productos WHERE tipo = 'Papa'");
                              while($hamb = mysqli_fetch_array($consulta)){
                            ?>
                            <tr>
                              <td><?php echo "$hamb[id]";?></td>
                      ...
                      <div class="col-sm-12">
                        ...
                        <table id="datatable-keytable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                          <thead>
                            ...
                            <tbody>
                            <?php
                              $consulta = mysqli_query($conexion,"SELECT * FROM productos WHERE tipo = 'Boneless'");
                              while($hamb = mysqli_fetch_array($consulta)){
                            ?>
                            <tr>
                              <td><?php echo "$hamb[id]";?></td>
                      ...
                      <div class="col-sm-12">
                        ...
                        <table id="datatable-fixed-col" class="table table-striped table-bordered" cellspacing="0" width="100%">
                          <thead>
                            ...
                            <tbody>
                            <?php
                              $consulta = mysqli_query($conexion,"SELECT * FROM productos WHERE tipo = 'Complemento'");
                              while($hamb = mysqli_fetch_array($consulta)){
                            ?>
                            <tr>
                              <td><?php echo "$hamb[id]";?></td>
